...
$user = $userService->getPatientByEmail($email)->fetch_assoc();
...
<div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
        <div class="contact-info d-flex align-items-center">
            ...
            ?> <i class="bi bi-phone"></i><?php echo $user["ptel"]; ?>
        </div>
...
<section>
    <div class="container d-grid    w-25" style="margin-top:100px ">
        ...
        <form action="../../services/update-patient.php" method="POST" class="add-new-form">
        ...
        <?php
        echo '<a href="?action=drop&id=' . $id . '" class="non-style-link">';
        ...
        if ($_GET) {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="../../services/delete-patients.php?id=' . $id . '" class="non-style-link"><button  class="btn-danger btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
