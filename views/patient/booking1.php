...
<center>
    <section class="w-50 text-center m-5">
        ...
        $doc_appoints = $appointmentService->listAppointmentsByDate($doc_id,$date);
      ...
      <div class="container d-grid  text-center   w-75" style="margin-top:100px ">
        <div class="row">
            ...
            <form action="../../services/add-booking.php" method="POST" class="add-new-form  ">
        ...
        $sessions_res =$appointmentService->getSessions();
