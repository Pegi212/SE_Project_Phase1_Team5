...
$email = $_SESSION["user"];
$patientrow1 = $userService->getPatientByEmail($email)->fetch_assoc();
...
<div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
        <div class="contact-info d-flex align-items-center">
            ...
            echo $patientrow1['name']; ?> &nbsp &nbsp
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <p class="heading-main12"
                   style=" margin-top:70px;margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Doctors
                    (<?php
                    $doctors = $userService->getDoctors();


                    echo $doctors->num_rows; ?>)</p>
