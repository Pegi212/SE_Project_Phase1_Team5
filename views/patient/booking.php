...
<center>
    <section class="w-50 text-center m-5">
        ...
        echo '<div class="container d-grid text-center w-75" style="margin-top:100px">
            <div class="row">
                <div class="col-12">
            ...
            <form action="booking1.php" method="POST" class="add-new-form" id="date_form">
                ...
                <input type="submit" value="Next" id="date_form_submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">
            </form>
        </div>';
