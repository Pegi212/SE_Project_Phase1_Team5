...
$email = $_SESSION["user"];
$user = $userService->getDoctorByEmail($email)->fetch_assoc();

$mypatientrow = $userService->getMyPatients($user["id"]);
...
<div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
        <div class="contact-info d-flex align-items-center">
            &nbsp &nbsp
            <i class="bi bi-person-circle"></i> Dr.<?php echo $user["name"] ?> &nbsp &nbsp
...
<section id="hero" class="d-flex align-items-center ">
    <div class="container">
        ...
        $myAppointments = $userService->getMyAppointmets($user["id"], $user["usertype"]);
        ?>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                    <div class="count-box ">
                        ...
                        <span data-purecounter-start="0" data-purecounter-end="  <?php echo $mypatientrow->num_rows ?>"
                              data-purecounter-duration="1" class="purecounter text-center"></span>
                        <h4> <?php echo $mypatientrow->num_rows ?></h4>
                ...
                <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                    <div class="count-box">
                        ...
                        <h4>
                            <?php echo $myAppointments->num_rows ?>
                        </h4>
