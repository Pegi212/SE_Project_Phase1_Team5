...
<section class="my-patients">
    <br>
    <br>
    <div class="container w-100 mt-5 h-auto d-grid">
        <?php

        $email = $_SESSION["user"];
        $doc_id = $userService->getUserByEmail($email)->fetch_assoc()["id"];


        $myPatients = $userService->getMyPatients($doc_id);
            ...
            <div class="col-8 text-center">
                <div class="search">
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        for ($y = 0; $y < $myPatients->num_rows; $y++) {
                            $row00 = $myPatients->fetch_assoc();
                            $d = $row00["name"];
                            $c = $row00["email"];
                ...
                <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">My Patients
                    (<?php echo $myPatients->num_rows; ?>)</p>
            </div>
        </div>
        <div class="row search-div">
        ...
        <div class="row search-div">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="delete-patients.php?id=' . $id . '" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="patients.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
