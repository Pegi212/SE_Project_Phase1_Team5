...
if ($_POST) {
    ...
    if ($newpassword == $cpassword) {
        ...
        if ($userService->getUserByEmail($email)) {
            ...
            $res = $userService->createUserP($name, $surname, $email, $paddress, $city, $reg_date, $ptel, $hashedPassword, "p");
            $_SESSION["user"] = $email;
            $_SESSION["usertype"] = "p";
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <script>
                                        function validateForm() {
                                            ...
                                            // Additional validation (e.g., email format, telephone format) can be added here
