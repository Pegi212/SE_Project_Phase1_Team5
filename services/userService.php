...
class UserService
{
    ...
    // Create a new user
    public function createUserP($name, $surname, $email, $paddress, $city, $reg_date, $ptel, $hashedPassword, $usertype)
    {
        ...
        if ($result) {
            ...
            $mysqli_result = $this->db->query(sprintf("INSERT INTO `patient` (`id`, `name`, `surname`, `address`, `city`, `reg_date`, `ptel`) VALUES ('%d', '%s', '%s', '%s', '%s', '%s', '%s')", $last_id, $name, $surname, $paddress, $city, $reg_date, $ptel));
    ...
    public function getUser($id)
    {
        ...
        if ($result->fetch_assoc()["usertype"] == 'd') {
